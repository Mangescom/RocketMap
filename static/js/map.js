        ...
        contentstring += `
          ...
          <div class='pokemon container content-right'>
            <div>
              ...
              <div class='pokemon'>
                IV: <span class='pokemon encounter'>${iv.toFixed(1)}%</span> (${atk}/${def}/${sta}) | CP: <span class='pokemon encounter'>${cp}</span> | Szint: <span class='pokemon encounter'>${pokemonLevel}</span>
              </div>
              <div class='pokemon'>
                Támadások: <span class='pokemon encounter'>${pMove1}/${pMove2}</span>
              </div>
              <div class='pokemon'>
...
=======
    if (includeMembers) {
>>>>>>> 1713397c83946d36ba1ebdd0ca863e54fd2886e4
        memberStr = '<div>'
    ...
    return `
                    <tr onclick=toggleGymPokemonDetails(this)>
                        ...
                        <td width="190" align="center">
                            ...
                            <div class="gym pokemon">Berakva: ${getDateStr(pokemon.deployment_time)}</div>
                        </td>
                        <td width="10">
