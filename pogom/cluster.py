...
class SpawnpointCluster(object):
...
def main(raw):
    radius = 70
    time_threshold = args.timetreshold
    #time_threshold = 180  # 5 minutes is alright to grab a pokemon since most times are 30m+
    spawnpoints = [SpawnpointCluster(x) for x in raw]  # separate them
